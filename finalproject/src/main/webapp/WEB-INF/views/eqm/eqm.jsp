	...
	<form id="insertForm" name="insertForm" action="eqm" method="POST">
		...
		<div>
			<div class="row g-3 align-items-center">
				...
				<div class="col-auto">
					<input type="text" name="eqmNm" placeholder="필수입력" class="form-control">
				</div>
				<div class="col-auto">
			...
			<div class="row g-3 align-items-center">
				...
				<div class="col-auto">
					<input type="number" style="width: 100px; display: inline-block;"
				...
				<div class="col-auto">
					<input type="text" name="eqmMng" class="form-control" placeholder="필수입력">
				</div>
				<div class="col-auto">
